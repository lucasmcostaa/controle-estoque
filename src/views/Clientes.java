...
public class Clientes extends JDialog {
	...
	public Clientes() {
		...
		btnPesquisarId.setIcon(new ImageIcon(Clientes.class.getResource("/img/search.png")));
		...
		btnPesquisarCep.setIcon(new ImageIcon(Clientes.class.getResource("/img/search.png")));
	...
	public void adicionar() {
		...
		if (txtNomeCliente.getText().isEmpty()) {
			...
			try {
				...
				JOptionPane.showMessageDialog(null, "Cliente não adicionado - CNPJ existente");
