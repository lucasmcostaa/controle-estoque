...
public class Produtos extends JDialog {
	...
	public Produtos() {
		...
		lblValidade.setBounds(474, 147, 60, 20);
		...
		lblUnidade.setBounds(5, 202, 55, 20);
		...
		txtLocalizacao.setBounds(233, 202, 120, 20);
		...
		txtCusto.setBounds(419, 202, 100, 20);
		...
		txtLucro.setBounds(579, 202, 100, 20);
		...
		btnCreate.setBounds(649, 371, 64, 64);
		...
		btnUpdate.setBounds(553, 371, 64, 64);
		...
		btnDelete.setBounds(470, 371, 64, 64);
		...
		btnPesquisarId.setIcon(new ImageIcon(Produtos.class.getResource("/img/search.png")));
		...
		scrollPane.setBounds(5, 39, 440, 150);
		...
		btnPesquisarIdFornecedor.setIcon(new ImageIcon(Produtos.class.getResource("/img/search.png")));
		...
		lblPorcentagem.setBounds(689, 202, 20, 20);
		getContentPane().add(lblPorcentagem);
		
		dateEntrada = new JDateChooser();
		dateEntrada.setEnabled(false);
		dateEntrada.setBackground(Color.WHITE);
		dateEntrada.setFont(new Font("Tahoma", Font.PLAIN, 11));
		dateEntrada.setDateFormatString("d/M/y");
		dateEntrada.setBounds(552, 71, 180, 20);
		getContentPane().add(dateEntrada);
		
		dateVal = new JDateChooser();
		dateVal.setFocusTraversalPolicyProvider(true);
		dateVal.setFocusCycleRoot(true);
		dateVal.setInheritsPopupMenu(true);
		dateVal.setIgnoreRepaint(true);
		dateVal.setDateFormatString("d/M/y");
		dateVal.setBounds(553, 147, 162, 20);
		...
		if (txtCodigoDeBarras.getText().isEmpty()) {
			...
			try {
				...
				if (confirma == 1) {
					...
					JOptionPane.showMessageDialog(null, "Produto não adicionado - Código de Barra existente");
		...
		if (txtCodigoDeBarras.getText().isEmpty()) {
			...
			try {
				...
				con.close();
					...
					JOptionPane.showMessageDialog(null, "Produto não atualizado - Código de Barra existente");
					txtCodigoDeBarras.setText(null);
					txtCodigoDeBarras.requestFocus();
			} catch (Exception e) {
				System.out.println(e);
